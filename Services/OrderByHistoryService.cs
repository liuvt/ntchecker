...
public class OrderByHistoryService : IOrderByHistoryService
{
    ...
    public async Task<Data.Models.GGSheetModels.Revenue> GetRevenue(string userId, string date)
    {
    ...
    // Lọc lại danh sách theo mã userId của tài xế [Họ tên - Mã nhân viên]
    public async Task<Data.Models.GGSheetModels.Timepiece> GetTimepiece(string userId, string date)
    {
    ...
    // Lọc lại danh sách theo mã userId của tài xế [Họ tên - Mã nhân viên]
    public async Task<Data.Models.GGSheetModels.Contract> GetContract(string userId, string date)
    {
