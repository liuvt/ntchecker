...
public class SalaryBase : ComponentBase
{
    ...
    private async Task<Data.Models.GGSheetModels.Salary> GetReSalary(string userId)
    {
        ...
        Deductions.AddRange(new List<Data.Models.GGSheetModels.DeductionItem>
        {
            ...
            new() { Name = "Lỗi bảo quản xe", Amount = salary.deductForVMV },
            new() { Name = "Lỗi đồng phục", Amount = salary.deductForUV },
            new() { Name = "Lỗi giao ca", Amount = salary.deductForSHV },
            new() { Name = "Lỗi sạc", Amount = salary.deductForChargingPenalty },
